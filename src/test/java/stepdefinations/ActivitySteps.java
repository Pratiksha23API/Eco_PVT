...
public class ActivitySteps  extends BaseClass {
	...
	@Then("Verify  downloaded file is avaliable in project folder with {string} name")
	public void verify_downloaded_file_is_avaliable_in_project_folder_with_name(String filename) throws Exception {
		ac.verifyIsFileIsDownloaded(filename);
	}
